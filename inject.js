...
var snuslashswitches = {
    ...
    "ucy": { "description": "Updated or Created Yesterday", "value": "^sys_created_onONYesterday@javascript:gs.beginningOfYesterday()@javascript:gs.endOfYesterday()^ORsys_updated_onONYesterday@javascript:gs.beginningOfYesterday()@javascript:gs.endOfYesterday()", "type": "encodedquerypart" },
    "uy": { "description": "Updated Yesterday", "value": "^sys_updated_onONYesterday@javascript:gs.beginningOfYesterday()@javascript:gs.endOfYesterday()", "type": "encodedquerypart" },
    "cy": { "description": "Created Yesterday", "value": "^sys_created_onONYesterday@javascript:gs.beginningOfYesterday()@javascript:gs.endOfYesterday()", "type": "encodedquerypart" },
